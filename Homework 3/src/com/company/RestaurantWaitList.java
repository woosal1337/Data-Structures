...
public class RestaurantWaitList {
    ...
    private final DoublyLinkedList<String> tables = new DoublyLinkedList<String>(new String[]{"Table 1", "Table 2", "Table 3", "Table 4", "Table 5"});
...
class CustomerLog {
    ...
    public void printLogs() {
        ...
        String table;
        Customer tempCustomer;
        System.out.println("Name\t\tArriving Time\t\tSitting Time\t\tLeaving Time\t\tTable Number");
        for (int i = 0; i < this.logSize; i++) {
            tempCustomer = log.get(i);
            if (tempCustomer.sittingTime == null) {
                System.out.println(tempCustomer.name + " \t\t" + tempCustomer.arrivingTime + "\t\t\t\t" + " " + "\t\t\t\t\t" + tempCustomer.leavingTime + "\t\t\t\t" + " ");
            } else {
                System.out.println(tempCustomer.name + " \t\t" + tempCustomer.arrivingTime + "\t\t\t\t" + tempCustomer.sittingTime + "\t\t\t\t" + tempCustomer.leavingTime + "\t\t\t\t" + tempCustomer.table);
            }
        }
    }
}